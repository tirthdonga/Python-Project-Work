...
- 1 -[👤 Create Person](#-create-person)
- 2 -[💼 Create Employee](#-create-employee)
- 3 -[🧑‍💼 Create Manager](#-create-manager)
- 4 -[👨‍💻 Create Developer](#-create-developer)
- 5 -[📄 Display All Records](#-display-all-records)
- 6 -[🔍 Check Subclass](#-check-subclass)
- 0 -[🧹 Destructor](#-destructor)
